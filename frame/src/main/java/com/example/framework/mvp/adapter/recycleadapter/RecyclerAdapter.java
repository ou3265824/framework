package com.example.framework.mvp.adapter.recycleadapter;
...
public abstract class RecyclerAdapter<T> extends RecyclerView.Adapter<RecycleHolder>{
    ...
    public void setBackgroundResource(RecycleHolder holder, int id){
        holder.itemView.setBackgroundResource(id);
    }
